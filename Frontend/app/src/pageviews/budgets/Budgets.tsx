...
export function Budgets({ locale }: { locale: 'es' | 'en' }) {
  ...
  const statusData = [{ name: 'Dentro del límite', value: counts.safe, color: '#15803d' },{ name: 'Cerca del límite', value: counts.near, color: '#f59e0b' },{ name: 'Excedido', value: counts.over, color: '#f43f5e' }];
