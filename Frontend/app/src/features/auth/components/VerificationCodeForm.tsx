...
export function VerificationCodeForm({ title, description, codeLabel, codePlaceholder, verifyLabel, resendLabel, changeEmailLabel, invalidCodeMessage, onVerify, onResend, onChangeEmail }: VerificationCodeFormProps) {
