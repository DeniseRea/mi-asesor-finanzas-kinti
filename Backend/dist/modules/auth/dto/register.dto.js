...
__decorate([
    ...
    (0, class_validator_1.Matches)(/^(?=.*\d)/, { message: 'Password must include at least one number' }),
    (0, class_validator_1.Matches)(/^(?=.*[!@#$%^&*()_+\-=\[\]{};':"\\|,.<>\/?])/, { message: 'Password must include at least one symbol' }),
    __metadata("design:type", String)
